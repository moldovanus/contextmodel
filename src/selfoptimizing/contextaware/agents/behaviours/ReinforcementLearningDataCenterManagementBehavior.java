...
import selfoptimizing.ontologyRepresentations.greenContextOntology.Component;
...
//        }
    ...
    protected Server getMinDistanceServer(Task task) {
        ...
        for (Server server : servers) {
            ...
            selfoptimizing.ontologyRepresentations.greenContextOntology.Memory mem = server.getAssociatedMemory();
