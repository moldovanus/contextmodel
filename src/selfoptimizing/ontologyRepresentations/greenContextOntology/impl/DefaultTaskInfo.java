...
import selfoptimizing.ontologyRepresentations.greenContextOntology.TaskInfo;
...
public class DefaultTaskInfo extends DefaultContextElement
    ...
    public void setCpu(int newCpu, OntModel model) {
        setPropertyValue(getCpuProperty(), new java.lang.Integer(newCpu), model);
    }
    ...
    public void setMemory(int newMemory, OntModel model) {
        setPropertyValue(getMemoryProperty(), new java.lang.Integer(newMemory), model);
    }
    ...
    public void setStorage(int newStorage, OntModel model) {
        setPropertyValue(getStorageProperty(), new java.lang.Integer(newStorage), model);
    }
