...
public class DatacenterMemory implements Serializable {
    ...
    public void restoreProtegeFactory(DatacenterProtegeFactory protegeFactory) {
    ...
    public Queue<Command> getActionsForTasks(DatacenterProtegeFactory protegeFactory) {
