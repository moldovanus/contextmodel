 ...
 */
package selfoptimizing.actionEnforcement.command.selfOptimizingCommand;
...
public abstract class SelfOptimizingCommand implements Command {
    protected transient DatacenterProtegeFactory protegeFactory;
    protected int cost;

    public SelfOptimizingCommand(DatacenterProtegeFactory protegeFactory) {
        this.protegeFactory = protegeFactory;
    }

    public final void setProtegeFactory(DatacenterProtegeFactory protegeFactory) {
        this.protegeFactory = protegeFactory;
    }
