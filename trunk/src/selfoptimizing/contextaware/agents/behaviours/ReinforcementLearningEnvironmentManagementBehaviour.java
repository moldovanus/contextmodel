...
import selfoptimizing.actionEnforcement.command.selfHealingCommand.DecrementCommand;
import selfoptimizing.actionEnforcement.command.selfHealingCommand.IncrementCommand;
import selfoptimizing.actionEnforcement.command.selfHealingCommand.SetCommand;
...
import selfoptimizing.utils.context.SensorValues;
...
public class ReinforcementLearningEnvironmentManagementBehaviour extends TickerBehaviour {
    ...
    public ReinforcementLearningEnvironmentManagementBehaviour(Agent a, int interval, OntModel policyConversionModel, JenaOWLModel jenaOWLModel, EnvironmentMemory memory) {
        super(a, interval);
    ...
    private void setBrokenResources(ContextSnapshot contextSnapshot) {
        ...
        try {
            X3DMessageDispatcher.sendMessage(agent, GlobalVars.GUIAGENT_NAME, new Object[]{"SelfHealingMonitor", "brokenPoliciesList", brokenPoliciesNames});
        } catch (IOException e) {
    ...
    protected void onTick() {
        ...
        try {
            X3DMessageDispatcher.sendMessage(agent, GlobalVars.GUIAGENT_NAME, new Object[]{"SelfHealingMonitor", "brokenStatesList", currentValues.toArrayList()});
            X3DMessageDispatcher.sendMessage(agent, GlobalVars.GUIAGENT_NAME, new Object[]{"SelfHealingMonitor", "actionsList", null});
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
...
//        resultsFrame.setBrokenStatesList(currentValues.toArrayList());
        ...
        if (entropyState.getFirst() != 0) {
            ...
            list.add(policyName);
            try {
                X3DMessageDispatcher.sendMessage(agent, "EnviromentLogger", new Object[]{"EnviromentLogger", Color.ORANGE, "Broken policy", list});
                X3DMessageDispatcher.sendMessage(agent, "EnviromentLogger", new Object[]{"EnviromentLogger", Color.red, "Current state", currentValues.toLogMessage()});
            } catch (IOException e) {
                e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
            }
            ...
            try {
                X3DMessageDispatcher.sendMessage(agent, "EnviromentLogger", new Object[]{"EnviromentLogger", Color.ORANGE, "Sensors that break the policies", brokenSensorsList});
            } catch (IOException e) {
                e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
            }
...
//                agent.setRlTime(value);
            ...
            try {
                X3DMessageDispatcher.sendMessage(agent, "EnviromentLogger", new Object[]{"EnviromentLogger", Color.BLUE, "Corrective actions", message});
            } catch (IOException e) {
                e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
            }
            ...
            System.err.println();
            try {
                X3DMessageDispatcher.sendMessage(agent, GlobalVars.GUIAGENT_NAME, new Object[]{"SelfHealingMonitor", "actionsList", actions});
            } catch (IOException e) {
                e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
            }
            ...
            if (contextBroken) {
                contextBroken = false;
                try {
                    X3DMessageDispatcher.sendMessage(agent, GlobalVars.GUIAGENT_NAME, new Object[]{"EnviromentLogger", Color.green, "Current state", currentValues.toLogMessage()});
                } catch (IOException e) {
                    e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
                }
