package selfoptimizing.contextaware.gui.datacenterConfiguration.impl;

import selfoptimizing.contextaware.gui.datacenterConfiguration.AbstractConfigurator;
import selfoptimizing.contextaware.gui.datacenterConfiguration.IServerTableModel;
import selfoptimizing.contextaware.gui.datacenterConfiguration.TableCellValueValidator;
...
public class ServerConfigurator extends AbstractConfigurator {
    ...
    private class ServerInfoTableModel extends AbstractTableModel implements IServerTableModel {
        ...
        public void createServerEntities(DatacenterProtegeFactory factory) {
    ...
    public void createEntities(DatacenterProtegeFactory factory) {
