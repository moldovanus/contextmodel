...
namespace ServerManagement
{
    class VMHandling
    {
        ...
        public static double prevCountValue = 0;
        public static double prevCountBase = 0;
        ...
        public static string GetPowerConsumption()
        {
            ...
            foreach (ManagementBaseObject obj in searcher.Get())
            {
                ...
                {
                    if (obj["currentVoltage"] != null)
                        powerConsumption += obj["CurrentVoltage"];
                }
            ...
            //while (i < 600)
            //{
            //    ManagementObject physDiskCounter = new ManagementObject(
            ...
            //    result += ((VMHandling.prevCountValue - newCountValue) /
            //                    (VMHandling.prevCountBase - newCountBase)) * 100;
            //    VMHandling.prevCountBase = newCountBase;
            //    VMHandling.prevCountValue = newCountValue;
            //    i++;
            //}
            //return (int)result;
